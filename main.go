...
import (
	...
	eventsv1alpha1 "github.com/akyriako/kvnts/api/v1alpha1"
	"github.com/akyriako/kvnts/controllers"
...
func main() {
	...
	clusterName, err := getCfgVar("CLUSTER_NAME")
	if err != nil {
		setupLog.Error(err, "unable to start manager")
		os.Exit(1)
	}

	lokiPushGatewayUrl, err := getCfgVar("LOKI_PUSH_GATEWAY_URL")
	if err != nil {
		setupLog.Error(err, "unable to start manager")
		os.Exit(1)
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9eeea382.kvnts",
