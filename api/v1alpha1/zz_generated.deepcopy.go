...
func (in *SinksConfigSpec) DeepCopyInto(out *SinksConfigSpec) {
	*out = *in
	out.Slack = in.Slack
	if in.ExcludedReasons != nil {
		in, out := &in.ExcludedReasons, &out.ExcludedReasons
